        ...
        public void ShowAddressBookMenu(AddressBook utils)
        {
            ...
            do
            {
                ...
                switch (choice2)
                {
                    ...
                    case 8:
                        utils.WriteContactsToCsv();
                        break;

                    case 9:
                        utils.ReadContactsFromCsv();
                        break;

                    case 10:
                        utils.WriteContactsToJson();
                        break;

                    case 11:
                        utils.ReadContactsFromJson();
                        break;

                    case 12:
                        utils.WriteContactsToJsonServer().Wait();
                        break;

                    case 13:
                        utils.ReadContactsFromJsonServer().Wait();
                        break;
                    case 0:
